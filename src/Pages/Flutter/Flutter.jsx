...
const FlutterData = [
  {
    ...
    title: "Модуль 1",
    theme_title: "Темы:",
    text: "Почему IT-компании не выжить без Flutter? Разбираемся, какую роль он выполняет и как именно сохраняет бизнесу деньги. Знакомимся с профессиями в IT, рассматриваем жизненный цикл разработки программного обеспечения",
    bullit1: "Введение в курс",
    bullit2: "Основы Flutter",
